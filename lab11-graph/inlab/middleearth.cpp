...
/*!\var string all_city_names[]
  \brief The list of all the place names that we'll be using
*/
...
/*!\fn MiddleEarth::MiddleEarth (int xsize, int ysize, int numcities, int seed)
...
/*!\fn MiddleEarth::printTable()
  \brief Prints a tab-separated table of the distances
  * (this can be loaded into Excel or similar)
  */
...
/*!\fn MiddleEarth::getDistance (string city1, string city2)
...
/*!\fn MiddleEarth::getItinerary(unsigned int length)
